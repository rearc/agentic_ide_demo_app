...
- **Setup + run:** see the "Local development" section above (Python 3.11+ venv on port 5001; `nvm use` then Vite on 5173). `backend/seed.py` is destructive - it wipes and re-seeds the `cards` and `todos` tables.
